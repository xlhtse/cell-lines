...
urls=(
    ...
    "https://www.cancerrxgene.org/gdsc1000/GDSC1000_WebResources///Data/otherAnnotations/methSampleId_2_cosmicIds.xlsx"
)
...
# TFs of TERT from TFLink
curl -o tf-of-tert.tsv https://cdn.netbiol.org/tflink/proteinDownload_tfs/TFLink_tfs_of_O14746.tsv
